...
public class Company implements Serializable{
    ...
    public Company() throws IOException {
        ...
        this.password = "admin";
        System.out.println("Company account created!");
    ...
    public Company(boolean value){
        ...
        if(choice == 0){
            ...
            System.out.println("Initializing products from prebuilt preferences...");
            Integer nProducts = 4;
            String[] productNames = new String[]{"Dettol", "Lifebuoy", "Vatika", "Himalaya"};
            Integer[] costs = new Integer[]{12, 24, 27, 100};
            Integer[] qtys = new Integer[]{100, 249, 234, 25};
